...
export const CHAT_HEADER: string = `YETI Customer Support Chatbot`;
export const MESSAGE_PLACEHOLDER: string = `[MESSAGE PLACEHOLDER]`;
export const FOOTER_MESSAGE: string = `© 2025 Daniel Xie`;
export const CLEAR_BUTTON_TEXT: string = `CLEAR CHAT`;
export const PAGE_TITLE: string = `YETI Chatbot`;
